class Site::ExpenseTypeController < SiteController
  ...
  def create
    ...
    respond_to do |format|
      if @expense_type.save
        format.html { redirect_to site_expense_type_index_path, notice: "A Categoria (#{@expense_type.description}) foi salva com sucesso!" }
  ...
  def update
    respond_to do |format|
      if @expense_type.update(expense_type_params)
        format.html { redirect_to site_expense_type_index_path, notice: "A Categoria (#{@expense_type.description}) foi atualizada com sucesso!" }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to site_expense_type_index_path, notice: "A Categoria (#{tipoDespesa}) foi deletada com sucesso!" }
